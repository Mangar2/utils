 ...
 */
function readConfigFile (defaultName: string, filePathAndName?: string): unknown {
 ...
 */
export function selectConfiguration (configuration: unknown): unknown {
 ...
 * @param {string} defaultName - Default configuration file name
 */
export function readConfiguration (defaultName: string): unknown {
    const parameters = getCommandLineParameters();
