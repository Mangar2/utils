...
function calcSun(date, longitude, latitude, zenith, isSunrise) {
    ...
    const cosSunLocalHourAngle = (cosDegree(zenith) - (sunDeclinationSin * sinDegree(latitude))) /
 ...
 */
export function sunset(longitude, latitude, date = new Date(), zenith = ZENITH) {
 ...
 */
export function sunrise(longitude, latitude, date = new Date(), zenith = ZENITH) {
