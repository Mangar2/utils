 ...
 * });
 */
export declare const delay: (timeInMilliseconds: number, verbose?: boolean) => Promise<void>;
/**
 ...
 */
export declare const delayStep: (timeInMilliseconds: number, stepInMilliseconds?: number, verbose?: boolean) => Promise<void>;
