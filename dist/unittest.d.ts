...
export declare class UnitTest {
  ...
  */
     ...
     */
    assertEqual: (a: any, b: any, message?: string) => boolean;
    /**
     ...
     */
    validateRec(toValidate: any, expected: any, path: string, exact?: boolean): void;
    /**
    ...
    */
    assertDeepEqual: (a: any, b: any, message?: string) => boolean;
    /**
