 ...
 */
import { UnitTest, TestResult } from './index';
type Test = {
    description: string;
    expected: any;
    [key: string]: any;
...
type PrepareCallback = (testcase: Testcase, testcasePath: string) => Promise<any> | any;
type RunCallback = (test: Test, testObject: any) => Promise<any> | any;
type ValidateCallback = (test: Test, result: any, testPath: string) => Promise<void> | void;
...
export declare class TestRun {
     ...
     */
    asyncValidate(test: Test, result: any, testPath: string, exact?: boolean): Promise<void>;
    /**
     ...
     * @param exact A boolean indicating whether the validation should be exact (strict).
     */
    validate(test: Test, result: any, testPath: string, exact?: boolean): void;
    /**
     ...
     * @param extension Optional file extension, defaults to 'json'.
     */
    run(files: string[] | string, directory: string, expectedAmount: number, extension?: string): TestResult;
}
export {};
